			...
			>
				...
				<div>
					<h1 className={`${styles.heroHeadText} text-white relative z-10`}>
						Hi, I'm <span className='text-clr_blue'>Tony</span>
					</h1>
					<p
						className={`${styles.heroSubText} relative z-10 mt-2 text-white-100 md:max-w-[640px] max-w-[460px] `}
					>
						I'm a Full-stack Developer with the 7 years of experience in Javascript, PHP,  Django and Wordpress. <br />I also develop 3D visuals, user interfaces and&nbsp;web
						applications.
					</p>
				</div>
			</div>
